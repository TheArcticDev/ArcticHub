...
local Functions = {
	...
	["writeclipboard"] = write_clipboard or writeclipboard or syn.write_clipboard or setclipboard or set_clipboard or "writeclipboard was not found in exploit environment",
...
warn([[ScriptWare Better Compatibilityâ„¢ has finished loading, Took: ]]..tostring(tick() - Timer):sub(1,14) .. "\n" .. "Credits to: Iris")
