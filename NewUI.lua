...
local darkmode = {
	...
	Bar = Color3.fromRGB(10, 10, 10),
	GUINameColor = Color3.fromRGB(255,255,255),
	PageFrame = Color3.fromRGB(20, 20, 20),
	BehindLogo = Color3.fromRGB(20, 20, 20),
	Logo = "rbxassetid://7913262129",
	BHLV = 0
}

local wintertheme = {
	MainBackground = Color3.fromRGB(170, 170, 170),
	Glow = Color3.fromRGB(6, 231, 255),
	DarkContrast = Color3.fromRGB(239, 239, 239),
	GUINameColor = Color3.fromRGB(255,255,255),
	Accent = Color3.fromRGB(44, 187, 206),
	BehindLogo = Color3.fromRGB(20, 20, 20),
	Logo = "rbxassetid://7913142824",
	BHLV = 1
}
...
--function to create gui objects
do
	...
	function utility:ScalingByDragEnabled(btn, target, minX, minY)
	...
	function library.new(title)
		local container = utility:Create("ScreenGui", {
			...
			utility:Create("ImageLabel", {
				...
				Image = "rbxassetid://7912003309",
				ImageColor3 = themes.MainBackground,
			}, {
				utility:Create("ImageLabel", {
					Name = "Glow",
					BackgroundTransparency = 1,
					Position = UDim2.new(-0.056, 0, -0.056, 0),
					Size = UDim2.new(1.11, 0, 1.11, 0),
					ZIndex = 0,
				...
				utility:Create("Frame", {
					...
					BackgroundColor3 = themes.BehindLogo,
					ZIndex = 1,
					BackgroundTransparency = themes.BHLV
				}, {
					utility:Create("ImageLabel", {
						Name = "Logo",
						BackgroundTransparency = 1,
				...
				utility:Create("ImageLabel", {
					...
					Position = UDim2.new(0, 0, 0.306, 0),
					Size = UDim2.new(0.23, 0, 0.694, 0),
					ZIndex = 3,
					Image = "rbxassetid://5012534273",
					ImageColor3 = themes.PageFrame,
				}, {
				...
				utility:Create("ImageLabel", {
					...
					BackgroundTransparency = 1,
					ClipsDescendants = true,
					Size = UDim2.new(1, 0, 0.076, 0),
					ZIndex = 5,
					Image = "rbxassetid://4595286933",
					ImageColor3 = themes.Bar,
				}, {
		...
		--utility:ScalingByDragEnabled(container.Main.ResizeButton, container.Main, 250, 250)
